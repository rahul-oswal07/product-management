...
export abstract class HttpService {
  ...
  protected getList<T>(
    ...
    const url = this.getUrl(
      pathParameters,
      this.createHttpParams(queryParameters)
    );
  ...
  protected getUrl(
    ...
    if (pathParameters) {
      const path = Array.isArray(pathParameters)
        ? pathParameters.join('/')
        : pathParameters;
